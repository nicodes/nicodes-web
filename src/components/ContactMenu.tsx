  ...
  return (
    <div class="relative" ref={root}>
      <button
        ...
        class="flex items-center gap-2 border-[3px] border-ink bg-coral px-4 py-1.5 text-lg font-bold text-paper shadow-sticker-sm transition-transform hover:-translate-y-0.5 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
      >
        Say hello
        <span
          aria-hidden="true"
